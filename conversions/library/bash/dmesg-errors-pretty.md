...
# Output {#output .unnumbered}
    ...
    \textbackslash\{\}u001b[1m=== KERNEL MESSAGE SUMMARY ===\textbackslash\{\}u001b[0m
    \textbackslash\{\}u001b[1m--- ERRORS \& WARNINGS ---\textbackslash\{\}u001b[0m
      err     : 2
      warn    : 3
      crit    : 1
    \textbackslash\{\}u001b[1m--- ALL MESSAGES (by severity) ---\textbackslash\{\}u001b[0m
      err     : 2
      warn    : 3
      crit    : 1
      notice  : 5
      info    : 12
      debug   : 0
    \textbackslash\{\}u001b[1m======================================\textbackslash\{\}u001b[0m
    ...
    kern  :warn  : [Tue Apr 21 10:08:34 2026] IPv6: ADDRCONF(NETDEV\_UP): eth0: link is not ready
