...
\noindent Lists all aliases defined in the user's shell configuration file in alphabetical order with colored, formatted output. Works with bash, zsh, and other shells on Linux and BSD systems.
